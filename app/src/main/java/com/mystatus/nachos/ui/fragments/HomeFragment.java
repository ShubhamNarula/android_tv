...
import com.mystatus.nachos.ui.Adapters.HomeAdapter;
...
public class HomeFragment extends Fragment {
    ...
    private void loadData() {
        ...
        String email = new PrefManager(getActivity()).getString("USERN_USER");
        Call<Data> call = service.homeData(email);
...
//                    }
                    if (response.body().getBigPosters().size() > 0) {
                        Data bigPostersData = new Data();
                        bigPostersData.setBigPosters(response.body().getBigPosters());
                        dataList.add(bigPostersData);
                    }
    ...
    private void initViews() {
        ...
        this.gridLayoutManager = new GridLayoutManager(getActivity().getApplicationContext(),
