...
public class PosterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PosterAdapter(Activity activity) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2: {
                View v2 = inflater.inflate(R.layout.item_empty_non_spacing, parent, false);
...
//                    holder.imgPlayas.setVisibility(View.VISIBLE);
                ...
                String mTitle = "";
                if (posterList.get(position).getTitle().length() >= 13) {
                    mTitle = posterList.get(position).getTitle().substring(0, 13) + "...";
                } else {
