...
import com.mystatus.nachos.Utils.Log;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)){
            case 1:
                ...
                ImageLoader.with(holder.itemView.getContext()).load(downloadItemList.get(position).getImage()).into(downloadedHolder.image_view_item_download_image);
                ...
                downloadedHolder.image_view_item_download_delete.setOnClickListener(v->{
                    ...
                    for (int i = 0; i < my_downloads_list.size(); i++) {
                        if (my_downloads_list.get(i).getId().equals(downloadItemList.get(position).getId()) ) {
                            ...
                            if (file.exists()){
                                com.mystatus.nachos.Utils.Log.log( "EXISTR");
                                try {
