...
public class PosterHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PosterHomeAdapter(List<Poster> posterList, Activity activity, boolean deletable) {
        this.posterList = posterList;
        this.activity = activity;
        this.deletable = deletable;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 1: {
                ...
                viewHolder = new PosterHomeHolder(v1);
                break;
            }
            case 2: {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        switch (getItemViewType(position)) {
            case 1:
                ...
                final PosterHomeHolder holder = (PosterHomeHolder) viewHolder;
                holder.poster_container.setLayoutParams(new LinearLayout.LayoutParams(350, 620));
                ...
                String mTitle = "";
                if (posterList.get(position).getTitle().length() >= 25) {
                    mTitle = posterList.get(position).getTitle().substring(0, 25) + "...";
                } else {
                ...
                if (lastTime != null && !lastTime.isEmpty()) {
                    ...
                    if (posterList.get(position).getType().equals("serie")) {
                        mTitle = posterList.get(position).getPoster_title();
                        holder.tvName.setText(mTitle);
                        holder.tvName.setVisibility(View.VISIBLE);
                    }else if (posterList.get(position).getType().equals("movie")) {
...
//                    activity.startActivity(intent1, activityOptionsCompat.toBundle());
    ...
    public class PosterHomeHolder extends RecyclerView.ViewHolder {
        ...
        public PosterHomeHolder(View itemView) {
            super(itemView);
