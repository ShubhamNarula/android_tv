...
import com.mystatus.nachos.ui.activities.ActorActivity;
...
public class ActorAdapter  extends  RecyclerView.Adapter<ActorAdapter.ActorHolder>{
        ...
        public void onBindViewHolder(ActorHolder holder, final int position) {
            ImageLoader.with(holder.itemView.getContext()).load(actorList.get(position).getImage()).placeholder(R.drawable.placeholder).into(holder.circle_image_view_item_actor);
